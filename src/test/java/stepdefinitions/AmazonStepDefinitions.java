...
AmazonPages amazonPages = new AmazonPages();
   ...
   String sonucYazisiString= amazonPages.sonucYazisiElementi.getText();
        Assert.assertTrue(sonucYazisiString.contains("iPhone"));
    ...
    public void sonuclarin_tea_pot_icerdigini_test_eder() {
        String sonucYazisiString= amazonPages.sonucYazisiElementi.getText();
        Assert.assertTrue(sonucYazisiString.contains("tea pot"));
    ...
    public void sonuclarin_flower_icerdigini_test_eder() {
        String sonucYazisiString= amazonPages.sonucYazisiElementi.getText();
        Assert.assertTrue(sonucYazisiString.contains("flower"));
    }
    ...
    public void sonuclarin_icerdigini_test_eder(String arananKelime) {
        String sonucYazisiString= amazonPages.sonucYazisiElementi.getText();
        Assert.assertTrue(sonucYazisiString.contains(arananKelime));
    }
